...
| | |
|---|---|
| **Phase** | P193 — four decisions of Vahid's recorded before the work they govern: blocker 60 leads with the method that found it; **blocker 62 decided and moved beside blocker 2 as a product precondition — a minor is not served until the guardian route is real**; blocker 61's country table is to be a reviewed, hashed artefact rather than a generated lookup; and **Sheffield's representative route is confirmed to EXIST**, its terms unread and not inferred, with the student's own account staying what is built. Before it, P192 — the fields whose value has several parts, asked part by part and confirmed once ([ADR-0140](./docs/decisions/0140-a-field-with-several-parts-is-asked-part-by-part.md)) |
