...
| | |
|---|---|
| **Phase** | P151 — a failed sign-in is tried twice, then stops for a person, and the student is told what cannot be told apart (ADR-0120); a seeded value says it was seeded (ADR-0121); two items open of ten |
...
| **Tests** | **2,684 passing · 142 files · zero skipped**, in two lanes — browsers serial, everything else parallel · typecheck, lint, boundary, reachability and contract checks green |
