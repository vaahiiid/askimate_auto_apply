...
| | |
|---|---|
| **Phase** | P48 — the record of what cannot be reached is checked too (ADR-0082) |
...
| **Tests** | **2,298 passing · 115 files · zero skipped**, in two lanes — browsers serial, everything else parallel · typecheck, lint, boundary, reachability and contract checks green |
| **Decisions** | 82 ADRs · 78 Accepted |
