...
| | |
|---|---|
| **Phase** | P159 — ADR-0126: the repair — a stop recorded before P158 needs a caller of its own, scoped to `WINDING_DOWN` and refused everywhere else; Run A parked at the sign-in awaiting one repeat |
...
| **Tests** | **2,724 passing · 143 files · zero skipped**, in two lanes — browsers serial, everything else parallel · typecheck, lint, boundary, reachability and contract checks green |
| **Decisions** | 126 ADRs · all 126 Accepted |
