...
| | |
|---|---|
| **Phase** | P172 — a consent path of more than one press must say what it means, so a portal with no control that says no says so in the question rather than leaving it to be inferred |
