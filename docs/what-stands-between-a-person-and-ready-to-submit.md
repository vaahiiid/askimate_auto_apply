...
- **2026-09-26 (P223):** the run stopped on the date of birth — two shapes refused, the question repeated verbatim with its reason dropped; the reader widened where unambiguous, the reason said, the attempt counted, the third failure a stop. The run continues from the same conversation.
- **2026-09-26 (P224):** P223 made it worse — a required field skipped, an answer read against the wrong question. ADR-0145: the count is written by the asking, the answer is read against the log's question, the first outstanding field is the only selection. The run continues from the same conversation; his two silent askings read as one.
- **2026-09-26 (P225):** the two-way date is offered as its two readings and the student picks — no attempt spent (ADR-0146); the Date the log turned into a string, fixed at the boundary and re-tagged by migration 0028; "specialist (running)" explained as a real state, row 92 for the word. About two and a quarter hours by the clock to 11:11 UTC against two and a half.
- **2026-09-26 (P226):** the two instruments that lied this week recorded as found by accident, and the third measured — a vitest name filter matching nothing is green; `pnpm run test:named` refuses a run in which nothing ran (row 93). Nothing on the list moved.
- **2026-09-26 (P227):** no internal word on a student's screen (ADR-0147) — the position line composed from sentences typed over the closed vocabularies; row 92 closed. Nothing on the list moved. About an hour and a quarter by the clock to 12:27 UTC against an hour and a quarter.
- **2026-09-26 (P228):** every part of every field asked for and played back by a person's name (row 92 closed again, ADR-0147 §5); his question on runs that matched nothing answered in row 93. Nothing on the list moved. About an hour by the clock to 13:40 UTC against two.
- **2026-09-26 (P229):** row 93 left as knowable in part and not pursued, in his words; the nested shapes noted, and the playback's tokens, minor units and month numbers replaced by a person's words. Nothing on the list moved. About an hour and a half by the clock to 15:25 UTC against twenty minutes; the three findings grew it.
- **2026-09-26 (P230):** ADR-0148 — the interview's shape, in his words, and the two CV decisions; §6–§7 built: a list confirmed as a whole and one entry corrected without retyping the rest. Nothing on the list moved; items 2 and 3 of his order follow. About two and three-quarter hours by the clock to 17:09 UTC against five.
