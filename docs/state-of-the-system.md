...
the sixth, a research build, was removed in P53 (ADR-0086). **2,479 tests, 130 files, zero skipped**, against real PostgreSQL and Redis, in two lanes —
...
**2,479 tests · 130 files · zero skipped · zero pending**, run against real PostgreSQL 16 and real
...
**2,479 tests**, by the workspace they live in. Generated — run
...
| `packages/domain` | 376 | `packages/mapping` | 48 |
| `scripts` | 306 | `packages/disclosure` | 47 |
| `apps/browser-runner` | 281 | `packages/profile` | 47 |
| `packages/case-store` | 145 | `packages/preparation` | 46 |
| `packages/orchestrator` | 117 | `packages/catalogue` | 42 |
