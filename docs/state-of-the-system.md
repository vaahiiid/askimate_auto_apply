...
the sixth, a research build, was removed in P53 (ADR-0086). **2,441 tests, 129 files, zero skipped**, against real PostgreSQL and Redis, in two lanes —
...
**2,441 tests · 129 files · zero skipped · zero pending**, run against real PostgreSQL 16 and real
...
**2,441 tests**, by the workspace they live in. Generated — run
...
| `scripts` | 299 | `packages/profile` | 46 |
| `apps/browser-runner` | 272 | `packages/preparation` | 43 |
