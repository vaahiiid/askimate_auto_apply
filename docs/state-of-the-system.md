...
the sixth, a research build, was removed in P53 (ADR-0086). **2,615 tests, 140 files, zero skipped**, against real PostgreSQL and Redis, in two lanes —
...
| 0111 | Employment history is a registry group of its own; a page of jobs repeats over it; a student with none sees that said plainly | Accepted · decides distance item 2; decided by Vahid, 2026-09-14; the shape proposed, awaiting his confirmation; not yet built |
...
**2,615 tests · 140 files · zero skipped · zero pending**, run against real PostgreSQL 16 and real
...
**2,615 tests**, by the workspace they live in. Generated — run
...
| `scripts` | 335 | `packages/profile` | 51 |
