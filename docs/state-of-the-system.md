...
| **20** | **A field the portal asks for that our rules forbid us to hold** — Sheffield's equal-opportunities page: eleven disability checkboxes, a support-needs box, an ethnic-origin select (Article 9). Sheet: [`decision-sheet-article-9-fields-a-portal-asks-for.md`](./decision-sheet-article-9-fields-a-portal-asks-for.md) | **Decided by Vahid, 2026-09-11**, in his words on the sheet: the empty save is refused, so *"use the refusal the form offers"* — tick *Prefer not to say* / the ethnic-origin opt-out as reviewed constants that are never presented as the student's answer — with three conditions to be enforced, not noted. Not yet built: expressibility answered first, as he asked | The mapping set for the first real blueprint, and the general rule for every Article 9 field a portal asks |
