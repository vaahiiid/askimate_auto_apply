...
the sixth, a research build, was removed in P53 (ADR-0086). **2,434 tests, 128 files, zero skipped**, against real PostgreSQL and Redis, in two lanes —
...
**2,434 tests · 128 files · zero skipped · zero pending**, run against real PostgreSQL 16 and real
...
**2,434 tests**, by the workspace they live in. Generated — run
...
| `apps/browser-runner` | 272 | `packages/preparation` | 41 |
| `packages/case-store` | 145 | `packages/catalogue` | 39 |
| `packages/orchestrator` | 114 | `packages/mapping` | 34 |
