...
the sixth, a research build, was removed in P53 (ADR-0086). **2,525 tests, 130 files, zero skipped**, against real PostgreSQL and Redis, in two lanes —
...
| **23** | **A companion the page will not save without** — Sheffield's education page records nothing when an evidence radio is unanswered, and ADR-0105 as built hands the radio to the student with its slot, so on this page the runner cannot save a qualification. Raised by Vahid, 2026-09-12: *"either the runner answers the radio after all — 'I will upload later' is not a claim about the document, it is a statement about when — or the whole page waits for the student."* Sheet: [`decision-sheet-blocker-23-a-companion-the-page-will-not-save-without.md`](./decision-sheet-blocker-23-a-companion-the-page-will-not-save-without.md) | You — in your words; then me | Any fill of Sheffield's education page: under ADR-0106 every qualification reads `uncertain` until this is decided. Options priced: A, a reviewer-named *when* value the runner sets and the preview shows (recommended); B, the whole page handed to the student; C, today's state, a look per item ending in *not recorded* |
...
**2,525 tests · 130 files · zero skipped · zero pending**, run against real PostgreSQL 16 and real
...
**2,525 tests**, by the workspace they live in. Generated — run
