...
export const BROWSER_TEST_FILES: readonly string[] = [
  ...
  "apps/browser-runner/src/create-account-consent.test.ts",
  ...
  "apps/browser-runner/src/observe-row-text.test.ts",
  ...
  "apps/browser-runner/src/sign-in-settle.test.ts",
  "apps/browser-runner/src/session-hold.test.ts",
  "apps/browser-runner/src/sheffield-typeahead.test.ts",
