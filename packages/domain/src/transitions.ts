...
export const ALLOWED_TRANSITIONS = {
  ...
  REQUIREMENTS_RESOLUTION: ["ELIGIBILITY_REVIEW", "PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "AWAITING_HUMAN_REVIEW", "CANCELLED", "FAILED_PERMANENT"],
  ...
  BLUEPRINT_REQUIRED: ["READY_TO_PREPARE", "ROUTE_FALLBACK", "AWAITING_HUMAN_REVIEW", "CANCELLED", "FAILED_PERMANENT"],
  ...
  VALIDATION_FAILED: ["PREPARING", "PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "AWAITING_HUMAN_REVIEW", "ROUTE_FALLBACK", "CANCELLED", "FAILED_PERMANENT"],

  // A handoff can resume into preparation or straight into submission — the
  // final-submission handoff is the latter.
  AWAITING_HANDOFF: ["PREPARING", "SUBMITTING", "AWAITING_HUMAN_REVIEW", "ROUTE_FALLBACK", "CANCELLED", "FAILED_PERMANENT"],

  AWAITING_HUMAN_REVIEW: ["PREPARING", "READY_TO_PREPARE", "AWAITING_STUDENT_AUTHORISATION", "PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "ROUTE_FALLBACK", "CANCELLED", "FAILED_PERMANENT"],

  AWAITING_STUDENT_AUTHORISATION: ["AUTHORISED", "PREPARING", "AWAITING_HUMAN_REVIEW", "CANCELLED", "FAILED_PERMANENT"],
  ...
  AUTHORISED: ["SUBMITTING", "AWAITING_HANDOFF", "AWAITING_STUDENT_AUTHORISATION", "PREPARING", "CANCELLED", "FAILED_PERMANENT"],

  SUBMITTING: ["SUBMITTED", "AWAITING_HANDOFF", "VALIDATION_FAILED", "ROUTE_FALLBACK", "FAILED_PERMANENT"],

  SUBMITTED: ["CONFIRMED", "FAILED_PERMANENT"],

  ROUTE_FALLBACK: ["PREPARING", "AWAITING_HANDOFF", "AWAITING_HUMAN_REVIEW", "AWAITING_STUDENT_AUTHORISATION", "CANCELLED", "FAILED_PERMANENT"],
