...
export const ALLOWED_TRANSITIONS = {
  // `READY_TO_PREPARE` directly, since ADR-0058: a case opens from an offer the
  // student accepted against an already-resolved, already-validated target, so
  // there is nothing left to resolve between opening and being ready.
  INTAKE: ["PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "READY_TO_PREPARE", "WINDING_DOWN", "FAILED_PERMANENT"],

  PROFILE_INCOMPLETE: ["PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "READY_TO_PREPARE", "WINDING_DOWN", "FAILED_PERMANENT"],

  DOCUMENTS_PENDING: ["PROFILE_INCOMPLETE", "DOCUMENTS_PENDING", "READY_TO_PREPARE", "AWAITING_HUMAN_REVIEW", "WINDING_DOWN", "FAILED_PERMANENT"],
